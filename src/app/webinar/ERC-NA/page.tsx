...
import { EVENT_DATE, IMAGE_BASE, PRICE } from "./constants";
import { ErcLandingClient, CTA } from "./erc-landing-client";

export const metadata: Metadata = {
  title: "The Easily Repeatable Content System | Live Workshop",
  description:
    "The exact framework behind 1 billion+ organic views, taught live in 90 minutes. " +
    PRICE +
    ". Join the workshop and learn how to build your own Easily Repeatable Content series.",
  openGraph: {
    title: "The Easily Repeatable Content System | Live Workshop",
    description:
      "The exact framework behind 1 billion+ organic views, taught live in 90 minutes. " +
...
export default function ErcNaWebinarPage() {
  return (
    <div className="min-h-screen bg-[#0d0d0d] pb-20 text-white md:pb-0">
          ...
          <div className="md:grid md:grid-cols-[1fr,minmax(0,340px)] md:gap-10 md:items-start">
            <div className="min-w-0 max-w-full">
              ...
              <p className="mt-2 font-obviously text-body-sm text-red md:text-body">
                Live Workshop | {EVENT_DATE} | 90 Minutes | {PRICE}
              </p>
      ...
      <section className="border-t border-white/10 py-12 md:py-16">
        <div className="mx-auto max-w-[900px] px-4">
          ...
          <div className="mt-6">
            <CTA>Join the Live Workshop for {PRICE}</CTA>
          </div>
        </div>
      </section>
