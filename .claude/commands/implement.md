...
5. When all steps are done:
   - Update CLAUDE.md to reflect any new commands or structural changes
   - Update the plan file Status to [x] Complete
   - Give Stanley a summary of everything changed

If anything unexpected comes up mid-implementation, stop and ask Stanley before continuing.
