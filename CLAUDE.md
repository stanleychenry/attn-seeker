...
**Purpose:** Close out a session by saving everything that matters.

Run this at the end of every session. Claude will:

1. Review the full conversation and identify anything new — decisions, pipeline updates, strategy changes, build progress, resolved questions
2. Edit only the context files that actually changed (primarily current-data.md, occasionally strategy.md)
3. Return a summary of what was updated and why, plus any open questions to carry forward
...
6. **End**: Run `/wrap` to save decisions, updates, and progress to context files
